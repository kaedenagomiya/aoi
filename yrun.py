...
#model_name = 'gradtfkfultts' #  gradtts,gradseptts, gradtfktts, gradtfk5tts, gradtimektts, gradfreqktts, "gradtfkfultts for tfkful_mask and plus"
#model_dir = 'run_tfkfulplus_k3' # run_tfkfulmask_k3 or run_tfkfulplus_k3, if you tfkful_*, gt, sgt, tfk_k3, tfk_k5, timek, freqk
model_name=  'gradtfktts'
model_dir = 'run_tfk_k3'
#~/aoi/logs4model/gradtfk5tts/run_tfk_k5/ckpt/gradtfk5tts_500_397001.pt
#ckpt_filename= f'{model_name}_500_397003.pt' #397001, plus500_397003 mask500_396308
ckpt_filename= f'{model_name}_500_397001.pt'
